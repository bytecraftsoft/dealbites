...
/* Highlighted Text */
.custom-table td:nth-child(4) { /* Title */
    font-weight: 600;
    color: #ffffff !important;
}

.custom-table td:nth-child(6),
.custom-table td:nth-child(7) { /* Price, Original Price */
    font-weight: 600;
    ...
    <ul class="pagination justify-content-center">
        ...
        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
            <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                <a class="page-link bg-dark text-light border-secondary" href="?page=<?php echo $i; ?>"><?php echo $i; ?></a>
            </li>
        <?php endfor; ?>
